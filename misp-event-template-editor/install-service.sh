#!/usr/bin/env bash
#
# Install the misp-event-template-editor as a systemd --user service.
#
# This renders systemd/misp-event-template-editor.service.template with the
...
#   PORT=5052 HOST=0.0.0.0 ./install-service.sh
#   WORKERS=4 ./install-service.sh
#
# After install:
#   systemctl --user start  misp-event-template-editor
...
SERVICE_NAME="misp-event-template-editor"
